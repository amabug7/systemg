define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    var Controller = {
        index: function () {
            Table.api.init({
                extend: {
                    index_url: 'platform/repairaction/index',
                    add_url: 'platform/repairaction/add',
                    edit_url: 'platform/repairaction/edit',
                    del_url: 'platform/repairaction/del',
                    multi_url: 'platform/repairaction/multi'
                }
            });
            var table = $("#table");
            table.bootstrapTable({
                ...
                columns: [[
                    ...
                    {field: 'risk_level', title: __('Risk_level'), operate: 'LIKE'},

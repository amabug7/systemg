define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'platform/repairlog/index',
                    table: 'platform_repair_log'
                }
            });
            var table = $("#table");
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'repair_type', title: __('Repair_type'), searchList: {"common": __('Common'), "game": __('Game')}},
                        {field: 'action_key', title: __('Action_key'), operate: 'LIKE'},
            ...
            $(document).off('click', '.btn-exportlogs').on('click', '.btn-exportlogs', function () {
                ...
                window.location.href = 'platform/repairlog/export' + window.location.search + connector + 'sort=' + sort + '&order=' + order;
            });
